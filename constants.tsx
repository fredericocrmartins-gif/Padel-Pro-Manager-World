...
// --- PADEL RACKET BRANDS ---
// Using ui-avatars to ensure valid public images for all brands
export const PADEL_RACKET_BRANDS: Brand[] = [
  { id: 'aca', name: 'ACA', logo: 'https://ui-avatars.com/api/?name=ACA&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'acero', name: 'Acero Padel', logo: 'https://ui-avatars.com/api/?name=AP&background=10221e&color=25f4c0&size=64' },
  { id: 'adidas', name: 'Adidas', logo: 'https://ui-avatars.com/api/?name=Adidas&background=000&color=fff&size=64&font-size=0.35' },
  { id: 'akkeron', name: 'Akkeron', logo: 'https://ui-avatars.com/api/?name=Akkeron&background=10221e&color=25f4c0&size=64&font-size=0.3' },
  { id: 'alacran', name: 'Alacran', logo: 'https://ui-avatars.com/api/?name=AL&background=10221e&color=25f4c0&size=64' },
  { id: 'ares', name: 'Ares', logo: 'https://ui-avatars.com/api/?name=Ares&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'babolat', name: 'Babolat', logo: 'https://ui-avatars.com/api/?name=Babolat&background=00AEEF&color=fff&size=64&font-size=0.3' },
  { id: 'beast', name: 'Beast Padel', logo: 'https://ui-avatars.com/api/?name=Beast&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'black_crown', name: 'Black Crown', logo: 'https://ui-avatars.com/api/?name=BC&background=111&color=fff&size=64' },
  { id: 'bonabola', name: 'Bonabola', logo: 'https://ui-avatars.com/api/?name=BB&background=10221e&color=25f4c0&size=64' },
  { id: 'bullpadel', name: 'Bullpadel', logo: 'https://ui-avatars.com/api/?name=BP&background=E55300&color=fff&size=64' },
  { id: 'cabra', name: 'Cabra', logo: 'https://ui-avatars.com/api/?name=Cabra&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'cartri', name: 'Cartri', logo: 'https://ui-avatars.com/api/?name=Cartri&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'cork', name: 'Cork', logo: 'https://ui-avatars.com/api/?name=Cork&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'donnay', name: 'Donnay', logo: 'https://ui-avatars.com/api/?name=Donnay&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'dopadel', name: 'Dopadel', logo: 'https://ui-avatars.com/api/?name=DP&background=10221e&color=25f4c0&size=64' },
  { id: 'drop_shot', name: 'Drop Shot', logo: 'https://ui-avatars.com/api/?name=DS&background=000&color=FFD700&size=64' },
  { id: 'dunlop', name: 'Dunlop', logo: 'https://ui-avatars.com/api/?name=Dunlop&background=000&color=FBEC5D&size=64&font-size=0.3' },
  { id: 'endless', name: 'Endless', logo: 'https://ui-avatars.com/api/?name=Endless&background=10221e&color=25f4c0&size=64&font-size=0.3' },
  { id: 'enebe', name: 'Enebe', logo: 'https://ui-avatars.com/api/?name=NB&background=10221e&color=25f4c0&size=64' },
  { id: 'fila', name: 'Fila', logo: 'https://ui-avatars.com/api/?name=Fila&background=00205B&color=E31D2B&size=64&font-size=0.4' },
  { id: 'fz_forza', name: 'FZ Forza', logo: 'https://ui-avatars.com/api/?name=FZ&background=10221e&color=25f4c0&size=64' },
  { id: 'goliat', name: 'Goliat', logo: 'https://ui-avatars.com/api/?name=Goliat&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'harlem', name: 'Harlem', logo: 'https://ui-avatars.com/api/?name=Harlem&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'head', name: 'Head', logo: 'https://ui-avatars.com/api/?name=Head&background=F60&color=fff&size=64&font-size=0.4' },
  { id: 'heroes', name: 'Heroes', logo: 'https://ui-avatars.com/api/?name=Heroes&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'hirostar', name: 'Hirostar', logo: 'https://ui-avatars.com/api/?name=HS&background=10221e&color=25f4c0&size=64' },
  { id: 'impero', name: 'Impero Padel', logo: 'https://ui-avatars.com/api/?name=Impero&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'jhayber', name: 'Jhayber', logo: 'https://ui-avatars.com/api/?name=Jhayber&background=10221e&color=25f4c0&size=64&font-size=0.3' },
  { id: 'joma', name: 'Joma', logo: 'https://ui-avatars.com/api/?name=Joma&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'k_swiss', name: 'K Swiss', logo: 'https://ui-avatars.com/api/?name=KS&background=10221e&color=25f4c0&size=64' },
  { id: 'kelme', name: 'Kelme', logo: 'https://ui-avatars.com/api/?name=Kelme&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'kombat', name: 'Kombat', logo: 'https://ui-avatars.com/api/?name=Kombat&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'kuikma', name: 'Kuikma', logo: 'https://ui-avatars.com/api/?name=Kuikma&background=0066CC&color=fff&size=64&font-size=0.35' },
  { id: 'legend', name: 'Legend', logo: 'https://ui-avatars.com/api/?name=Legend&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'lok', name: 'LOK', logo: 'https://ui-avatars.com/api/?name=LOK&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'magnus', name: 'Magnus Padel', logo: 'https://ui-avatars.com/api/?name=Magnus&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'middlemoon', name: 'Middlemoon', logo: 'https://ui-avatars.com/api/?name=MM&background=10221e&color=25f4c0&size=64' },
  { id: 'nox', name: 'Nox', logo: 'https://ui-avatars.com/api/?name=Nox&background=E60000&color=fff&size=64&font-size=0.4' },
  { id: 'osaka', name: 'Osaka', logo: 'https://ui-avatars.com/api/?name=Osaka&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'our_padel', name: 'Our Padel Story', logo: 'https://ui-avatars.com/api/?name=OPS&background=10221e&color=25f4c0&size=64' },
  { id: 'oxdog', name: 'Oxdog', logo: 'https://ui-avatars.com/api/?name=Oxdog&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'padel_force', name: 'Padel Force', logo: 'https://ui-avatars.com/api/?name=PF&background=10221e&color=25f4c0&size=64' },
  { id: 'pallap', name: 'Pallap', logo: 'https://ui-avatars.com/api/?name=Pallap&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'prince', name: 'Prince', logo: 'https://ui-avatars.com/api/?name=Prince&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'pro_kennex', name: 'Pro Kennex', logo: 'https://ui-avatars.com/api/?name=PK&background=10221e&color=25f4c0&size=64' },
  { id: 'puma', name: 'PUMA', logo: 'https://ui-avatars.com/api/?name=PUMA&background=000&color=fff&size=64&font-size=0.4' },
  { id: 'quad', name: 'Quad', logo: 'https://ui-avatars.com/api/?name=Quad&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'raw', name: 'Raw', logo: 'https://ui-avatars.com/api/?name=Raw&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'royal_padel', name: 'Royal Padel', logo: 'https://ui-avatars.com/api/?name=RP&background=444&color=fff&size=64' },
  { id: 'rs', name: 'RS', logo: 'https://ui-avatars.com/api/?name=RS&background=10221e&color=25f4c0&size=64' },
  { id: 'salming', name: 'Salming', logo: 'https://ui-avatars.com/api/?name=Salming&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'sane', name: 'Sane', logo: 'https://ui-avatars.com/api/?name=Sane&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'set', name: 'SET', logo: 'https://ui-avatars.com/api/?name=SET&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'shooter', name: 'Shooter', logo: 'https://ui-avatars.com/api/?name=Shooter&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'side_spin', name: 'Side Spin', logo: 'https://ui-avatars.com/api/?name=SS&background=10221e&color=25f4c0&size=64' },
  { id: 'siux', name: 'Siux', logo: 'https://ui-avatars.com/api/?name=Siux&background=000&color=fff&size=64&font-size=0.4' },
  { id: 'skull', name: 'Skull Padel', logo: 'https://ui-avatars.com/api/?name=Skull&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'slazenger', name: 'Slazenger', logo: 'https://ui-avatars.com/api/?name=Slazenger&background=10221e&color=25f4c0&size=64&font-size=0.3' },
  { id: 'softee', name: 'Softee', logo: 'https://ui-avatars.com/api/?name=Softee&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'starvie', name: 'StarVie', logo: 'https://ui-avatars.com/api/?name=SV&background=000&color=FFD700&size=64' },
  { id: 'stiga', name: 'Stiga', logo: 'https://ui-avatars.com/api/?name=Stiga&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'tactical', name: 'Tactical Padel', logo: 'https://ui-avatars.com/api/?name=TP&background=10221e&color=25f4c0&size=64' },
  { id: 'techton', name: 'Techton of Sweden', logo: 'https://ui-avatars.com/api/?name=Techton&background=10221e&color=25f4c0&size=64&font-size=0.3' },
  { id: 'tecnifibre', name: 'Tecnifibre', logo: 'https://ui-avatars.com/api/?name=Tecni&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'tenax', name: 'Tenax Padel', logo: 'https://ui-avatars.com/api/?name=Tenax&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'tretorn', name: 'Tretorn', logo: 'https://ui-avatars.com/api/?name=Tretorn&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'vairo', name: 'Vairo', logo: 'https://ui-avatars.com/api/?name=Vairo&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'varlion', name: 'Varlion', logo: 'https://ui-avatars.com/api/?name=Varlion&background=FFCC00&color=000&size=64&font-size=0.35' },
  { id: 'vibora', name: 'Vibor-A', logo: 'https://ui-avatars.com/api/?name=VA&background=333&color=0F0&size=64' },
  { id: 'vidar', name: 'Vidar of Båstad', logo: 'https://ui-avatars.com/api/?name=Vidar&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'volt', name: 'Volt', logo: 'https://ui-avatars.com/api/?name=Volt&background=10221e&color=25f4c0&size=64&font-size=0.4' },
  { id: 'wallich', name: 'Wallich', logo: 'https://ui-avatars.com/api/?name=Wallich&background=10221e&color=25f4c0&size=64&font-size=0.35' },
  { id: 'wilson', name: 'Wilson', logo: 'https://ui-avatars.com/api/?name=Wilson&background=C8102E&color=fff&size=64&font-size=0.4' },
  { id: 'zerv', name: 'ZERV', logo: 'https://ui-avatars.com/api/?name=ZERV&background=10221e&color=25f4c0&size=64&font-size=0.4' },
